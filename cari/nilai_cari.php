					...
					<div class="box">
						...
						<table width="100%" cellspacing="2" cellpadding="2" style="margin-bottom:20px; font-size:14px;">
							<tr bgcolor="silver" style="text-align:center; font-weight:bold;">
								...
								<?php
									$cari	= $_POST['cari']; 
									$query 	= "SELECT * FROM nilai WHERE nisn LIKE '%$cari%'";
							...
							<tr style="font-size:14px;">
								...
								<td  style="text-align:center;">
									...
									<a href="./../act/delete_nilai.php?id_delete=<?php $row[0] ?>" onClick="return confirm('HAPUS DATA NILAI <?php echo $row[1];?> ?');">
