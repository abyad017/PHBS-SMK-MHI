...
<!-- 			<li style="width:100px;"><a href="admin.php?page=bantuan">Bantuan</a></li> -->
	...
	<?php } //Menu Siswa/Wali > Akhir I ?> 

	<?php if($_SESSION['level']=="Siswa"){ //Menu Siswa > Awal II ?>
	<li><a href="admin_sw.php?page=sw_laporan">Laporan</a></li>
	<?php } //Menu Siswa > Akhir II ?>
	
	<?php if($_SESSION['level']=="Wali"){ //Menu Wali > Awal III ?>
	<li><a href="admin_sw.php?page=wm_laporan">Laporan</a></li>
	<?php } //Menu Wali > Akhir III ?>
	
	<?php 	//Menu Siswa/Wali > Awal IV
		if(($_SESSION['level']=="Siswa") || ($_SESSION['level']=="Wali")){
	?>
	<li><a href="#">Info</a>
		<ul style="left:30%;">
